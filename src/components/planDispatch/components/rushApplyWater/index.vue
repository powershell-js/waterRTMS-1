        ...
        <el-row>
            <el-col :span="12">
                <div class="left-wapper">
                    ...
                    <div class="box2">
                        <div>今年预测高峰供水水量<el-input class="elInput" v-model="gsl"></el-input>（万吨/日）</div>
                        <!-- <div>今年预测高峰供水时间&nbsp;<span>{{baseInfo.ThisYearForecastHeightTime}}</span></div> -->
                        <div>今年预测高峰供水时间&nbsp;<span>218-08-20</span></div>
                    </div>
                </div>
            </el-col>
            <el-col :span="12">
...
import tablist from './tabList.vue';
    ...
    export default {
        ...
        methods: {
           ajaxConditionData(){
               let self = this;
               this.$axios.post(urlClass.axiosUrJH+"ConditionSetting").then(function(ret){
                   let d = ret.data;
                    self.baseInfo = d;
           ...
           ajaxPressData(){
               let self = this;
               this.$axios.post(urlClass.axiosUrJH+"GetPressurePoint").then(function(ret){
                    let d = ret.data;
