<template>
    <div class="box">
        ...
        <div class="contentbox1-1">
            <Echarts1 :nsJSLData="nsJSLData" :nsJSLTime="nsJSLTime"></Echarts1>
        </div>

        <div class="contentbox3-1">
            <Echarts3 :nsQSCData="nsQSCData" :nsQSCTime="nsQSCTime"></Echarts3>
        </div>
...
export default {
  ...
  mounted(){
    ...
    let self = this;
    this.ajaxJSLData();
    this.nsTimer=setInterval(function(){
        self.ajaxJSLData();
    },900000)
  },
  methods: {
       ajaxJSLData(){
        ...
        .then(res => {
            ...
            self.nsJSLData = data1;
            self.nsJSLTime = time1;
            self.nsQSCData = data2;
            self.nsQSCTime = time2;
        })
        .catch(error => {
            console.log(error);
        });
