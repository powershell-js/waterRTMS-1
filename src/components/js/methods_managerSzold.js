...
import pinClass from '@/components/js/PipeBurst/PictureProperty'
    ...
    initMap(obj) { // 初始化地图,并设置中心点等
        ...
        window.addEventListener('event_name',function(event){
                ...
                else if(typeMy=="DrawAccuracyMonitor")
                {
                  ...
                  /*  console.log(mapObjMy)
                    dialog.startup();
                    accuracyMonitorLayer.on("mouse-over", function(evt){
                        ...
                        + "<b>2007 Population per Sq. Mi.: </b>${POP07_SQMI:NumberFormat}";
                         dialog.setContent(t);
                         mapObjMy.domStyle.set(dialog.domNode, "opacity", 0.85);
                         mapObjMy.popup.open({
                             popup: dialog,
                             x: 1000,
                             y: 184
        ...
        function PositionMax(pointTemp,maxTemp){
           ...
           // var pictureMarkerSymbol = new mapObjMy.PictureMarkerSymbol(maxSource, 20, 41);
            var gra1 = drawClass.CreatePictureGraphic(pinClass.bluePin,pointTemp)//new esri.Graphic(pointTemp, pictureMarkerSymbol);  
            MaxLayer.add(gra1); 
        ...
        function PositionMin(pointTemp,maxTemp){
            ...
            var gra1 = drawClass.CreatePictureGraphic(pinClass.redPin,pointTemp)//new esri.Graphic(pointTemp, pictureMarkerSymbol);  
            MinLayer.add(gra1); 
        ...
        */
        ...
        function PositionMy(geometry){
            LocationGraphicsLayer.clear();
            var gra1 = drawClass.CreatePictureGraphic(pinClass.redPin,geometry)//new esri.Graphic(geometry, LocationMarkerSymbol);
