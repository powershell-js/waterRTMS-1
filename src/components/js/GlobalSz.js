export default{
    ...
    pipeSlopIsDisplay:[true,true,true,true,true],
     ...
     demandIsDisplay:[true,true,true,true,true],
      ///////////////////供水分界线/////////////////////////////////////////
      pipeSupplyAreaLimit:[218484,218481,218509,222318,218504,222319,218499,222317],
      pipeSupplyAreaColor:["#ff0000","#00c7ff","#a4bed4","#c61c84","#ff00c6","#c61c00","#00e7ee","#a4becc"],
      pipeSupplyAreaWidth:[5,5,5,5,5,5,5,5],
      pipeSupplyCompareAreaWidth:[2,2,2,2,2,2,2,2],
      pipeSupplyAreaIsDisplay:[true,true,true,true,true,true,true,true,],
      pipeSupplyAreaLabels:['南山水厂','东湖水厂','笔架山水厂','盐田港水厂自流','梅林水厂','盐田港水厂加压','大涌新老水厂出水管总瞬时流量','沙头角水厂'],
     ///////////////////管龄/////////////////////////////////////////
     ...
     pipeAgeIsDisplay:[true,true,true,true,true,true,true,true,true],
      ///////////////////管径分类/////////////////////////////////////////
    ...
    pipeDiameterIsDisplay:[true,true,true,true,true,true],
     ...
     pipeMaterialLimit:['','Ductile Iron','PE','塑料','铸铁'],
     pipeMaterialColor:["#A524AA","#A52484","#18388C","#847D42","#632CA5"],
     pipeMaterialWidth:[5,5,5,5,5],
     pipeMaterialIsDisplay:[true,true,true,true,true],
    ///////////////////水龄/////////////////////////////////////////
