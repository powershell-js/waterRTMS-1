...
<div class="box">
    ...
    <div class="contentbox1" v-show="cont1">
        <div class="titlebox">
            <div class="intitlebox"  @click="content1"><img class="img" src="../../../../static/assets/img/深水_日常调度_切图_55.png" alt=""> 水厂水量信息（万m3）</div>
        </div>
        <ul class="listbox">
    ...
    <div class="contentbox1-1" v-show="cont11">
        <div class="titlebox1-1">
            <div class="intitlebox1-1"  @click="content11"><img class="img" src="../../../../static/assets/img/深水_日常调度_切图_38.png" alt=""> 水厂水量信息（万m3）</div>
            <ul class="listbox1-1">
