<template>
    <div class="vue-datepicker">
        <input class="textInput" @click.stop="show=!show" :value="current | dateFormat" type="text" readonly>
        <div v-if="show" class="vue-datepicker-wrap">
            ...
            <div class="vue-datepicker-content">
                ...
                <div v-if="selectYear" class="vue-date-picker-year-panel">
                    <ul ref="year">
                        <li :key="y" v-for="y of years" @click.stop="pickYear(y)" :class="{'active': y == select.year}">{{y}}</li>
                    </ul>
                    <ul ref="month">
                        <li :key="m" v-for="(m, $index) of months" 
        ...
        methods: {
            ...
            */
            ...
            complete() {
                ...
                this.selectDate.year = this.select.year;
                this.selectDate.month = this.select.month;
                this.selectDate.date = this.select.date;
