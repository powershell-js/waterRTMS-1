...
import ListTable from '@/components/rcdd/components/dyblistecharts/listtable'
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
  ...
  methods: {
      ...
      document.getElementById("tslidingImglineb").style.left =tInsetlinelocationline + "px";
    document.getElementById("slidingImglineb2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb2").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglineb3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb3").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglineb4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb4").style.left =tInsetlinelocationline4 + "px";
       document.getElementById("slidingImglineb5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineb5").style.left =tInsetlinelocationline5+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
