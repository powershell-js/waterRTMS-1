...
import ListTable from '@/components/rcdd/components/mllistecharts/listtable'
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
  ...
  methods: {
    LopTime() {
      ...
      document.getElementById("tslidingImglinem").style.left =tInsetlinelocationline + "px";
    document.getElementById("slidingImglinem2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem2").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglinem3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem3").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglinem4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem4").style.left =tInsetlinelocationline4 + "px";
       document.getElementById("slidingImglinem5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinem5").style.left =tInsetlinelocationline5+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
