...
import ListTable from "@/components/rcdd/components/nslistecharts/listtable";
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
       ...
       this.tablistHeight = document.documentElement.clientHeight -374;
    window.onresize = function() {
     self.tablistHeight = document.documentElement.clientHeight -374;
    };
  },
  methods: {
    LopTime() {
      ...
      document.getElementById("tslidingImglinens").style.left =tInsetlinelocationline + "px";
    document.getElementById("slidingImglinens2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens2").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglinens3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens3").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglinens4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens4").style.left =tInsetlinelocationline4 + "px";
       document.getElementById("slidingImglinens5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglinens5").style.left =tInsetlinelocationline5+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
