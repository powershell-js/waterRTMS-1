...
<div class="box" :style="{height:tablistHeight+'px'}">
    ...
    <div class="contentbox1" v-show="cont1">
        <div class="titlebox">
            <div class="intitlebox"  @click="content1"><img class="img" src="../../../assets/img/深水_日常调度_切图_55.png" alt=""> 水厂水量信息（万m3）</div>
        </div>
        <ul class="listbox">
    ...
    <div class="contentbox1-1" v-show="cont11">
        <div class="titlebox1-1">
            <div class="intitlebox1-1"  @click="content11"><img class="img" src="../../../assets/img/深水_日常调度_切图_38.png" alt=""> 水厂水量信息（万m3）</div>
            <ul class="listbox1-1">
...
import ListTable from "@/components/rcdd/components/bjslistecharts/listtable";
...
export default {
  ...
  mounted() {
    ...
    this.tablistHeight = document.documentElement.clientHeight -334;
    window.onresize = function() {
     self.tablistHeight = document.documentElement.clientHeight -334;
    };
  },
  methods: {
     LopTime() {
      ...
      document.getElementById("slidingImgline").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImgline").style.left =tInsetlinelocationline + "px";
    document.getElementById("slidingImgline2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImgline2").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImgline3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImgline3").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImgline4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImgline4").style.left =tInsetlinelocationline4 + "px";
       document.getElementById("slidingImgline5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImgline5").style.left =tInsetlinelocationline5+ "px";
    },
    content1() {
      this.cont1 = false;
      this.cont11 = true;
