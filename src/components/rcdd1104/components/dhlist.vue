...
import ListTable from '@/components/rcdd/components/dhlistecharts/listtable'
...
　　　　　/* console.log(`echats1msg传来的数据是：${e}`) */
  ...
  methods: {
    LopTime() {
      ...
      document.getElementById("tslidingImglineh").style.left =tInsetlinelocationline + "px";
    document.getElementById("slidingImglineh2").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineh2").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglineh3").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineh3").style.left =tInsetlinelocationline + "px";
       document.getElementById("slidingImglineh4").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineh4").style.left =tInsetlinelocationline4 + "px";
       document.getElementById("slidingImglineh5").style.left =Insetlinelocationline + "px";
      document.getElementById("tslidingImglineh5").style.left =tInsetlinelocationline5+ "px";
    },
      content1(){
              this.cont1=false;
              this.cont11=true;
